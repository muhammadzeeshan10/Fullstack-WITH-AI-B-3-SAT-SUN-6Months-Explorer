...
df = pd.read_csv('C:\Users\Zeeshan PC\Documents\GitHub\Fullstack-WITH-AI-B-3-SAT-SUN-6Months-Explorer-Newv3\Week3\zameencom-property-data-By-Kaggle-Short.csv',delimiter=";",parse_dates=[14], date_format={'date_added': '%d-%m-%Y'})
